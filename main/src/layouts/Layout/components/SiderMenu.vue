...
<template>
  <el-menu class="layout-menu" :mode="mode" :collapse="collapsed" :collapse-transition="false"
    :default-active="defaultActive">
    <sider-menu-item v-for="item in permissionMenuData" :key="item.path" :route-item="item">
    </sider-menu-item>
