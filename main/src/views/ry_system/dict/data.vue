...
import { optionselect as getDictOptionselect, getType } from "@/services/system_ry/dict/type";
import { listData, getData, delData, addData, updateData } from "@/services/system_ry/dict/data";
    ...
    if (valid) {
      if (form.value.dictCode != undefined) {
        updateData(form.value).then(response => {
          store.state.ry_dict.removeDict(queryParams.value.dictType);
