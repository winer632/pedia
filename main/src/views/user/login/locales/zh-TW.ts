export default {
  'page.user.login.form-item-username': '用戶名',
  'page.user.login.form-item-username.required': '請輸入用戶名',
  'page.user.login.form-item-password': '密碼',
  'page.user.login.form-item-password.required': '請輸入密碼',
  'page.user.login.form-item-password.min': '密碼至少6位',
  ...
  'page.user.login.rememberMe': '記住密碼',
  'page.user.login.form.forget': '忘記密碼?',
  'page.user.login.form.forget-success': '請聯係管理員修改密碼',
};
