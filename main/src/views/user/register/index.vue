  ...
  <div class="main">
    ...
    <el-form :model="modelRef" :rules="rulesRef" ref="formRef">
      <el-form-item label="" prop="username">
        <el-input v-model="modelRef.username" :placeholder="t('page.user.register.form-item-username')"
          @keydown.enter="handleSubmit" />
      </el-form-item>
      <el-form-item label="" prop="password">
        <el-input type="password" v-model="modelRef.password" :placeholder="t('page.user.register.form-item-password')"
          @keydown.enter="handleSubmit" />
      </el-form-item>
      <el-form-item label="" prop="confirm">
        <el-input type="password" v-model="modelRef.confirm"
          :placeholder="t('page.user.register.form-item-confirmpassword')" @keydown.enter="handleSubmit" />
      </el-form-item>
      <el-form-item>
      ...
      <el-alert v-if="errorMsg !== '' && typeof errorMsg !== 'undefined' && !submitLoading" :title="errorMsg"
